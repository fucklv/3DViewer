...
"""
  ...
  def setBrowserWidgetInDICOMLayout(self, browserWidget):
    ...
    if self.viewWidget is None:
      ...
      layoutWidget = qt.QHBoxLayout()
      labelWidget.setLayout(layoutWidget)
      
      
      label = qt.QLabel("DICOM database")
      label.setSizePolicy(qt.QSizePolicy.Expanding, qt.QSizePolicy.Fixed)
      layoutWidget.addWidget(label)
      layoutWidget.setContentsMargins(13, 0, 0, 0)
      
      layout.addWidget(labelWidget)
      layout.setSpacing(10)
      
      self.viewWidget.setStyleSheet("QWidget{font: 10pt 'Microsoft YaHei';}")
      label.setStyleSheet('QLabel{font: 12pt "Microsoft YaHei";}')
...
class DICOMWidget(ScriptedLoadableModuleWidget):
  ...
  def setup(self):
    ...
    self.ui.label_5.visible = False
    self.ui.subjectHierarchyTree.visible = False
    self.ui.showBrowserButton.visible = False
    #
    # DICOM networking
    #
    ...
    self.ui.networkingFrame.visible = False
