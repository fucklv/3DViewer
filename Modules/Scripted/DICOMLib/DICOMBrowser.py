...
class SlicerDICOMBrowser(VTKObservationMixin, qt.QWidget):
  ...
  def setup(self, showPreview=False):
    ...
    self.advancedViewButton.visible = False
    ...
    self.setStyleSheet('QPushButton{font: 10pt "Microsoft YaHei"; min-width: 100;  max-width: 100; min-height: 24; max-height:24; background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}'\
    'QCheckBox{color: rgb(255, 255, 255);spacing: 7px;}QCheckBox::indicator{width: 16px;height: 16px;}QCheckBox::indicator:unchecked{image: url(:/Icons/CheckBoxImage1.png);}QCheckBox::indicator:checked{image: url(:/Icons/CheckBoxImage.png);}'\
    'QToolButton{font: 10pt "Microsoft YaHei";width: 20; max-width: 20; background: #191925; border: 1px solid #5c5c74;}QToolButton:hover{background-color: #5C5C74;}'\
    'QTableView{alternate-background-color:#e3edf9;gridline-color: #5c5c74;background: #191925;border: 1px solid #5c5c74;selection-background-color: #6987d5;font: 11pt "Microsoft YaHei";color: rgb(255, 255, 255);}'\
    'QHeaderView::section{background: #191925;border: 1px solid #5c5c74;background-color:transparent}'\
    'QTreeView::item{height: 26;alternate-background-color:#e3edf9;gridline-color: #5c5c74;selection-background-color: #6987d5;font: 11pt "Microsoft YaHei";color: rgb(255, 255, 255);}'\
    'QLineEdit{height: 24px;background: #1a1a26;border: 1px solid #5c5c74;}')
