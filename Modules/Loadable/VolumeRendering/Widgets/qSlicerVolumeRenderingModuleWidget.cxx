...
void qSlicerVolumeRenderingModuleWidgetPrivate::setupUi(qSlicerVolumeRenderingModuleWidget* q)
{
  ...
  this->VolumePropertyNodeWidget->layout()->setSpacing(6);
  ...
  this->InputsCollapsibleButton->setVisible(false);
  this->AdvancedCollapsibleButton->setVisible(false);
...
void qSlicerVolumeRenderingModuleWidget::updateWidgetFromMRML()
{
  ...
  d->ROIWidget->layout()->setSpacing(10);
...
void qSlicerVolumeRenderingModuleWidget::on_RenameVlButton_clicked()
{
    Q_D(qSlicerVolumeRenderingModuleWidget);

    d->VolumeNodeComboBox->renameCurrentNode();
}

void qSlicerVolumeRenderingModuleWidget::on_DeleteVlButton_clicked()
{
    Q_D(qSlicerVolumeRenderingModuleWidget);

    d->VolumeNodeComboBox->removeCurrentNode();
}
