/*==============================================================================
  ...
  WITHOUT WARRANTIES OR CONDIyiTIONS OF ANY KIND, either express or implied.
...
//QVariant qMRMLSegmentsModel::data(const QModelIndex& index, int role) const
//{
