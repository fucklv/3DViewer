...
public slots:
    ...
    //kyo
    void SetMrmlChange(vtkMRMLNode* node);

    //kyo
    void SetMasterVolumeChange(bool*);
...
protected slots:
  ...
  void on_RenameCurrentSgButton_clicked();
  
  void on_CreateNewSgButton_clicked();
  
  void on_CreateNewSgAsButton_clicked();
  
  void on_DleCurrentSgButton_clicked();
  
  void on_RenameCurrentVleButton_clicked();
