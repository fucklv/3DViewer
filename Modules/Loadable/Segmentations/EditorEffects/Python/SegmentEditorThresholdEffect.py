...
<li><b>Apply:</b> set the previewed segmentation in the selected segment. Previous contents of the segment is overwritten.</li>
  ...
  def setupOptionsFrame(self):
    ...
    iconTextLabel.setText(" 阈值")
    iconTextLabel.setStyleSheet("QLabel{ font: 12pt 'Microsoft YaHei';}")
    iconImageLabel.setStyleSheet("QLabel{min-width: 13; min-height: 13; max-width: 13; max-height: 13;background-image: url(:/Icons/ThresholdSg1.png)}")
    ...
    self.thresholdSliderLabel = qt.QLabel("阈值范围:")
    #self.thresholdSliderLabel.setToolTip("Set the range of the background values that should be labeled.")
    self.thresholdSliderLabel.setStyleSheet("QLabel{ font: 12pt 'Microsoft YaHei';}")
    ...
    #self.setAutoThresholdButton.setToolTip("使用所选方法设置阈值。")
    ...
    #autoThresholdFrame.setContentsMargins(0, 15, 0, 0)
    
    self.autoThresholdModeSelectorComboBox.setStyleSheet("QComboBox{font: 10pt 'Microsoft YaHei';height: 24; max-height:24; }")
    self.autoThresholdMethodSelectorComboBox.setStyleSheet("QComboBox{font: 10pt 'Microsoft YaHei'; height: 24; max-height:24; }")
    self.selectPreviousAutoThresholdButton.setStyleSheet("QToolButton{font: 10pt 'Microsoft YaHei';width: 68; max-width: 68; height: 24; max-height:24; background: #191925; border: 1px solid #5c5c74;}QToolButton:hover{background-color: #5C5C74;}")
    self.selectNextAutoThresholdButton.setStyleSheet("QToolButton{font: 10pt 'Microsoft YaHei';width: 68; max-width: 68; height: 24; max-height:24; background: #191925; border: 1px solid #5c5c74;}QToolButton:hover{background-color: #5C5C74;}")
    self.setAutoThresholdButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';width: 68;  max-width: 68; height: 24; max-height:24; background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")

    autoThresholdGroupBox = ctk.ctkCollapsibleGroupBox()
    autoThresholdGroupBox.setTitle("自动阈值")
    autoThresholdGroupBox.setStyleSheet("QGroupBox{ font: 10pt 'Microsoft YaHei';}")
    ...
    autoThresholdGroupBox.setVisible(False)

    histogramFrame = qt.QVBoxLayout()
    #histogramFrame.setContentsMargins(0, 15, 0, 0)
    ...
    self.circleROIButton.setText("圆")
    ...
    self.histogramLowerThresholdMinimumButton.setText("最小值")
    ...
    self.histogramLowerThresholdLowerButton.setText("下")
    ...
    self.histogramLowerThresholdAverageButton.setText("平均")
    ...
    #upperHistogramLayout.setContentsMargins(0, 15, 0, 0)
    
    self.histogramUpperThresholdMaximumButton = qt.QPushButton()
    self.histogramUpperThresholdMaximumButton.setText("最大值")
    ...
    self.histogramUpperThresholdUpperButton.setText("上")
    ...
    self.histogramUpperThresholdAverageButton.setText("平均")
    ...
    histogramGroupBox.setTitle("局部直方图")
    histogramGroupBox.setStyleSheet("QGroupBox{ font: 10pt 'Microsoft YaHei';}")
    ...
    histogramGroupBox.setVisible(False)

    self.useForPaintButton = qt.QPushButton("用于遮蔽")
    ...
    finishFrame.addStretch()
    finishFrame.addWidget(self.useForPaintButton)
    finishFrame.addWidget(self.applyButton)
    self.scriptedEffect.addOptionsWidget(finishFrame)
    finishFrame.setSpacing(10)
    
    self.useForPaintButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';width: 68; height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    ...
    self.boxROIButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';width: 68; height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    self.circleROIButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';width: 68; height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    self.drawROIButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';width: 68; height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    self.lineROIButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';width: 68; height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    self.histogramLowerThresholdMinimumButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';width: 68; height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    self.histogramLowerThresholdLowerButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';width: 68; height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    self.histogramLowerThresholdAverageButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';width: 68; height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    self.histogramUpperThresholdAverageButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';width: 68; height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    self.histogramUpperThresholdUpperButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';width: 68; height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    self.histogramUpperThresholdMaximumButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';width: 68; height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
