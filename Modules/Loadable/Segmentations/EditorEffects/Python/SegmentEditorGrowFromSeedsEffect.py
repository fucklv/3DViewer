...
class SegmentEditorGrowFromSeedsEffect(AbstractScriptedSegmentEditorAutoCompleteEffect):
  ...
  def __init__(self, scriptedEffect):
    ...
    scriptedEffect.toolTipName = 'Grow from seeds'
...
<p></html>"""
  ...
  def setupOptionsFrame(self):
    ...
    #self.scriptedEffect.addLabeledOptionsWidget("区域:", self.seedLocalityFactorSlider)
    ...
    labeltip = qt.QLabel()
    labeltip.setText("种子位置:")
    self.scriptedEffect.addOptionsWidget(labeltip)
    self.scriptedEffect.addOptionsWidget(self.seedLocalityFactorSlider)
    labeltip.setVisible(False)
    self.seedLocalityFactorSlider.setVisible(False)
