...
If segments overlap, segment higher in the segments table will have priority. <b>Applied to all visible segments.</b></li>
  ...
  def setupOptionsFrame(self):
    ...
    iconTextLabel.setText(" 平滑")
    iconTextLabel.setStyleSheet("QLabel{ font: 12pt 'Microsoft YaHei';}")
    iconImageLabel.setStyleSheet("QLabel{min-width: 13; min-height: 13; max-width: 13; max-height: 13;background-image: url(:/Icons/SmoothingSg1.png)}")
    ...
    vboxLayout.setContentsMargins(0,4,0,4)
    ...
    self.methodSelectorComboBox.setFixedHeight(21)
    
    vboxLayout3 = qt.QVBoxLayout()
    vboxLayout3.addStretch(1)
    self.scriptedEffect.addOptionsWidget(vboxLayout3)
    vboxLayout3.setContentsMargins(0,4,0,4)
    ...
    self.gaussianStandardDeviationMMSpinBox.setFixedHeight(21)
    ...
    vboxLayout1 = qt.QVBoxLayout()
    vboxLayout1.addStretch(1)
    self.scriptedEffect.addOptionsWidget(vboxLayout1)
    vboxLayout1.setContentsMargins(0,4,0,4)
    ...
    self.applyButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';min-width: 68; min-height:24; max-width: 68; max-height:24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
