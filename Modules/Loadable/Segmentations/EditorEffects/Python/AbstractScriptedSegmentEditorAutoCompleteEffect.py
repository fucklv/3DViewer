...
class AbstractScriptedSegmentEditorAutoCompleteEffect(AbstractScriptedSegmentEditorEffect):
  ...
  def setupOptionsFrame(self):
    ...
    self.iconImageLabel = qt.QLabel()
    self.iconTextLabel = qt.QLabel()
    
    self.iconTextLabel.setStyleSheet("QLabel{ font: 12pt 'Microsoft YaHei';}")
    self.iconTextLabel.text = " Grow from seeds"
    self.iconImageLabel.setStyleSheet("QLabel{min-width: 13; min-height: 13; max-width: 13; max-height: 13;background-image: url(:/Icons/GrowFromSeedSg1.png)}")
    
    iconFrame.addWidget(self.iconImageLabel)
    iconFrame.addWidget(self.iconTextLabel)
    iconFrame.addStretch()
    self.scriptedEffect.addOptionsWidget(iconFrame)
  
    self.autoUpdateCheckBox = qt.QCheckBox("自动升级")
    ...
    self.autoUpdateCheckBox.setStyleSheet("QCheckBox{font: 10pt 'Microsoft YaHei';}")
    self.autoUpdateCheckBox.setVisible(False)

    self.previewButton = qt.QPushButton("升级")
    ...
    self.previewButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';width: 68; max-width: 68; height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    self.previewButton.setIcon(qt.QIcon(':/Icons/ChangeIcon.png'))

    previewFrame = qt.QHBoxLayout()
    previewFrame.addStretch()
    previewFrame.addWidget(self.autoUpdateCheckBox)
    previewFrame.addWidget(self.previewButton)
    previewFrame.setSpacing(8)
    ...
    self.previewShow3DButton = qt.QPushButton("显示3D")
    #self.previewShow3DButton.setToolTip("Preview results in 3D.")
    self.previewShow3DButton.setCheckable(True)
    self.previewShow3DButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';width: 68; height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    self.previewShow3DButton.setIcon(qt.QIcon(':/Icons/3Dshow.png'))

    displayFrame = qt.QHBoxLayout()
    #displayFrame.addWidget(qt.QLabel("透明度："))
    displayFrame.addWidget(self.previewOpacitySlider)
    displayFrame.addWidget(self.previewShow3DButton)
    displayFrame.setSpacing(8)
    
    self.scriptedEffect.addLabeledOptionsWidget("预览:", previewFrame)
    
    showLabel = qt.QLabel("透明度：")
    self.scriptedEffect.addOptionsWidget(showLabel)
    self.scriptedEffect.addOptionsWidget(displayFrame)
    ...
    self.cancelButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';width: 68;height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}QPushButton:disabled {background-color: #70708d;}")
    
    self.applyButton = qt.QPushButton("应用")
    self.applyButton.objectName = self.__class__.__name__ + 'Apply'
    #self.applyButton.setToolTip("Replace segments by previewed result")
    self.applyButton.setStyleSheet("QPushButton{font: 10pt 'Microsoft YaHei';width: 68;height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}QPushButton:disabled {background-color: #70708d;}")
