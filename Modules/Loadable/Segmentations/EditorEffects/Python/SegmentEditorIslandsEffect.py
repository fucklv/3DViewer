...
class SegmentEditorIslandsEffect(AbstractScriptedSegmentEditorEffect):
  ...
  def __init__(self, scriptedEffect):
    ...
    scriptedEffect.toolTipName = 'Islands'
  ...
  def setupOptionsFrame(self):
    ...
    iconTextLabel.setText(" Islands")
    iconTextLabel.setStyleSheet("QLabel{ font: 12pt 'Microsoft YaHei';}")
    iconImageLabel.setStyleSheet("QLabel{min-width: 13; min-height: 13; max-width: 13; max-height: 13;background-image: url(:/Icons/IslandsSg1.png)}")
    ...
    vLayout.addStretch()
    self.scriptedEffect.addOptionsWidget(vLayout)
