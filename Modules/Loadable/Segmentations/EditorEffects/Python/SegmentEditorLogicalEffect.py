...
class SegmentEditorLogicalEffect(AbstractScriptedSegmentEditorEffect):
  ...
  def __init__(self, scriptedEffect):
    ...
    scriptedEffect.toolTipName = 'Logical operators'
...
<p></html>"""
  ...
  def setupOptionsFrame(self):
    ...
    iconTextLabel.setText(" Logical operators")
    iconTextLabel.setStyleSheet("QLabel{ font: 12pt 'Microsoft YaHei';}")
    iconImageLabel.setStyleSheet("QLabel{min-width: 13; min-height: 13; max-width: 13; max-height: 13;background-image: url(:/Icons/LogicalSg1.png)}")
    ...
    self.methodSelectorComboBox.setFixedWidth(107)
    ...
    self.bypassMaskingCheckBox = qt.QCheckBox("绕过遮罩")
    ...
    self.bypassMaskingCheckBox.setStyleSheet("QCheckBox{font: 10pt 'Microsoft YaHei';}")
