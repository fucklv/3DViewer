...
public:
  ...
  /// This property stores the toolTipName of the effect
  /// Cannot be empty.
  /// \sa toolTipName(), \sa setToolTipName()
  Q_PROPERTY(QString toolTipName READ toolTipName WRITE setToolTipName)
...
public:
  ...
  /// Get ToolTipName of effect
  virtual QString toolTipName()const;
  /// Set the ToolTipName of the effect
  /// NOTE: ToolTipName must be defined in constructor in C++ effects, this can only be used in python scripted ones
  virtual void setToolTipName(QString name);
