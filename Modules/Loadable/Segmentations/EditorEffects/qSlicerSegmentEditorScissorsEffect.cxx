...
qSlicerSegmentEditorScissorsEffectPrivate::qSlicerSegmentEditorScissorsEffectPrivate(qSlicerSegmentEditorScissorsEffect& object)
  : q_ptr(&object)
{
  this->ScissorsIcon = QIcon(":Icons/ScissorsSg1.png");
 ...
 , d_ptr( new qSlicerSegmentEditorScissorsEffectPrivate(*this) )
{
  ...
  this->m_ToolTipName = QString("Ότµ¶");
...
void qSlicerSegmentEditorScissorsEffect::setupOptionsFrame()
{
  ...
  QLabel* ScissorsImageLabel = new QLabel();
  QLabel* ScissorsTextLabel = new QLabel();
  ScissorsImageLabel->setStyleSheet("QLabel{min-width: 13; min-height: 13; max-width: 13; max-height: 13;background-image: url(:/Icons/ScissorsSg1.png)}");
  ScissorsTextLabel->setText(" Ότµ¶");

  iconLayout->addWidget(ScissorsImageLabel);
  iconLayout->addWidget(ScissorsTextLabel);
  ...
  d->gridLayout->addLayout(iconLayout, 0, 0);
  ...
  d->gridLayout->addWidget(new QLabel("Operation:"), 1, 0);
  d->gridLayout->addWidget(d->eraseInsideRadioButton, 3, 0);
  d->gridLayout->addWidget(d->eraseOutsideRadioButton, 2, 1);
  d->gridLayout->addWidget(d->fillInsideRadioButton, 2, 0);
  d->gridLayout->addWidget(d->fillOutsideRadioButton, 3, 1);
  ...
  d->gridLayout->addWidget(new QLabel("Shape:"), 4, 0);
  d->gridLayout->addWidget(d->freeFormRadioButton, 5, 0);
  d->gridLayout->addWidget(d->circleRadioButton, 5, 1);
  d->gridLayout->addWidget(d->rectangleRadioButton, 6, 0);
  ...
  d->gridLayout->addWidget(sliceCutModeLabel, 7, 0);
  d->gridLayout->addWidget(d->unlimitedRadioButton, 8, 0);
  d->gridLayout->addWidget(d->positiveRadioButton, 8, 1);
  d->gridLayout->addWidget(d->negativeRadioButton, 9, 0);
  //d->gridLayout->addWidget(d->symmetricRadioButton, 9, 1);
  //d->gridLayout->addWidget(d->sliceCutDepthSpinBox, 10, 0);

  QHBoxLayout* iconLayout1 = new QHBoxLayout();
  iconLayout1->addWidget(d->symmetricRadioButton);
  iconLayout1->addWidget(d->sliceCutDepthSpinBox);
  iconLayout1->addStretch();
  iconLayout1->setSpacing(4);
  d->gridLayout->addLayout(iconLayout1, 10, 0);
  d->gridLayout->setHorizontalSpacing(4);
  d->gridLayout->setVerticalSpacing(12);
  d->gridLayout->setContentsMargins(0, 4, 0, 4);
