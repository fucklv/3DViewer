...
QString qSlicerSegmentEditorAbstractEffect::toolTipName() const
{
    if (m_ToolTipName.isEmpty())
    {
        qCritical() << Q_FUNC_INFO << ": Empty effect ToolTipName!";
    }
    return this->m_ToolTipName;
}

void qSlicerSegmentEditorAbstractEffect::setToolTipName(QString name)
{
    Q_UNUSED(name);
    qCritical() << Q_FUNC_INFO << ": Cannot set effect name by method, only in constructor!";
}
