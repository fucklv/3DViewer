...
public:
  ...
  /// All/Visibel buttons
  QButtonGroup* ImportAllVisibelButtonGroup;
};
...
qSlicerSegmentationsModuleWidgetPrivate::qSlicerSegmentationsModuleWidgetPrivate(qSlicerSegmentationsModuleWidget& object)
  ...
  , ImportAllVisibelButtonGroup(nullptr)
{
}
...
void qSlicerSegmentationsModuleWidget::init()
{
  ...
  d->ComBoBoxButtonWidget->setVisible(false);
  d->ComBoBoxButtonWidgetMove->setVisible(false);

  d->label_ReferenceVolumeText->setVisible(false);
  d->label_ReferenceVolumeName->setVisible(false);
  d->CollapsibleButton_Representations->setVisible(false);
  d->CollapsibleButton_ExportToFiles->setVisible(false);
  d->CollapsibleButton_BinaryLabelmapLayers->setVisible(false);
  //d->label_ImportExportType->setVisible(false);
  //d->radioButton_Labelmap->setVisible(false);
  //d->radioButton_Model->setVisible(false);
  d->CollapsibleGroupBox_ImporExportAdvanced->setVisible(false);
  //d->label_ImportExportType->setVisible(false);
  d->CollapsibleButton_Display->setCollapsed(false);
  d->CollapsibleButton_ImportExportSegment->setCollapsed(false);
  d->CollapsibleButton_CopyMoveSegment->setCollapsed(false);

  d->ImportAllVisibelButtonGroup = new QButtonGroup(d->CollapsibleButton_ImportExportSegment);
  d->ImportAllVisibelButtonGroup->addButton(d->radioButton_AllSeg);
  d->ImportAllVisibelButtonGroup->addButton(d->radioButton_VisibleSeg);
  ...
  connect(d->ImportAllVisibelButtonGroup, SIGNAL(buttonClicked(QAbstractButton*)),
      this, SLOT(updateImportAllVisibleWidgets()));
  ...
  d->radioButton_Model->setChecked(true);
  d->radioButton_Labelmap->setChecked(false);
  d->radioButton_AllSeg->setChecked(true);
  d->SubjectHierarchyComboBox_ImportExport->setDefaultText("Export models to new folder");
  this->updateImportExportWidgets();
  this->updateImportAllVisibleWidgets();
}
...
void qSlicerSegmentationsModuleWidget::updateImportExportWidgets()
{
  ...
  if (d->radioButton_Export->isChecked())
    ...
    d->PushButton_ImportExport->setText("µ¼³ö");
    ...
    d->PushButton_ImportExport->setText("ÊäÈë");
...
//-----------------------------------------------------------------------------
void qSlicerSegmentationsModuleWidget::on_RenameCurrentSgSButton_clicked()
{
    Q_D(qSlicerSegmentationsModuleWidget);
    d->MRMLNodeComboBox_Segmentation->renameCurrentNode();
}

void qSlicerSegmentationsModuleWidget::on_CreateNewSgSButton_clicked()
{
    Q_D(qSlicerSegmentationsModuleWidget);
    d->MRMLNodeComboBox_Segmentation->createNewAndAsNode("Create new Segmentation");
}

void qSlicerSegmentationsModuleWidget::on_CreateNewSgSAsButton_clicked()
{
    Q_D(qSlicerSegmentationsModuleWidget);
    d->MRMLNodeComboBox_Segmentation->createNewAndAsNode("Create new Segmentation as...");
}

void qSlicerSegmentationsModuleWidget::on_DleCurrentSgSButton_clicked()
{
    Q_D(qSlicerSegmentationsModuleWidget);
    d->MRMLNodeComboBox_Segmentation->removeCurrentNode();
}

void qSlicerSegmentationsModuleWidget::on_RenameCurrentCMButton_clicked()
{
    Q_D(qSlicerSegmentationsModuleWidget);
    d->MRMLNodeComboBox_OtherSegmentationOrRepresentationNode->renameCurrentNode();
}

void qSlicerSegmentationsModuleWidget::on_CreateNewCMButton_clicked()
{
    Q_D(qSlicerSegmentationsModuleWidget);
    d->MRMLNodeComboBox_OtherSegmentationOrRepresentationNode->createNewAndAsNode("Create new Segmentation");
}

void qSlicerSegmentationsModuleWidget::on_CreateNewCMAsButton_clicked()
{
    Q_D(qSlicerSegmentationsModuleWidget);
    d->MRMLNodeComboBox_OtherSegmentationOrRepresentationNode->createNewAndAsNode("Create new Segmentation as...");
}

void qSlicerSegmentationsModuleWidget::on_DleCurrentCMButton_clicked()
{
    Q_D(qSlicerSegmentationsModuleWidget);
    d->MRMLNodeComboBox_OtherSegmentationOrRepresentationNode->removeCurrentNode();
}

void qSlicerSegmentationsModuleWidget::updateImportAllVisibleWidgets()
{
    Q_D(qSlicerSegmentationsModuleWidget);

    // Operation: all/Visible
    if (d->radioButton_AllSeg->isChecked())
    {
        d->ComboBox_ExportedSegments->setCurrentText("All");
    }
    else // Visible
    {
        d->ComboBox_ExportedSegments->setCurrentText("Visible");
    }
}
