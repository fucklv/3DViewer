...
protected slots:
  ...
  //--------------------------2020.11.24----------------------------//
  void on_RenameCurrentSgSButton_clicked();

  void on_CreateNewSgSButton_clicked();

  void on_CreateNewSgSAsButton_clicked();

  void on_DleCurrentSgSButton_clicked();

  //----------------------------------------------------------------//
  void on_RenameCurrentCMButton_clicked();

  void on_CreateNewCMButton_clicked();

  void on_CreateNewCMAsButton_clicked();

  void on_DleCurrentCMButton_clicked();

  void updateImportAllVisibleWidgets();
