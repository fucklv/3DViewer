...
void qSlicerModelsModuleWidget::setup()
{
  ...
  d->FilterModelSearchBox->setClearIcon(QIcon(":/Icons/clear1.png"));
  d->FilterModelSearchBox->setSearchIcon(QIcon(":/Icons/Search1.png"));

  d->DisplayButton->setVisible(false);
  d->ClippingButton->setVisible(false);
  d->FilterModelSearchBox->setVisible(false);
...
void qSlicerModelsModuleWidget::setDisplaySelectionFromSubjectHierarchyItems(QList<vtkIdType> itemIDs)
{
  ...
  d->MRMLModelInfoWidget->setMRMLModelNode(firstDataNode);
