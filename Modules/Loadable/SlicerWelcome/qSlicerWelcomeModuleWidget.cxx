...
void qSlicerWelcomeModuleWidget::setup()
{
  ...
  d->FeedbackCollapsibleWidget->setVisible(false);
  d->WelcomeAndAboutCollapsibleWidget->setVisible(false);
  d->OtherUsefulHintsCollapsibleWidget->setVisible(false);
  d->AcknowledgmentCollapsibleWidget->setVisible(false);
}
