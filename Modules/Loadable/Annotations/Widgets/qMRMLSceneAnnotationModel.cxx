...
void qMRMLSceneAnnotationModelPrivate::init()
{
  ...
  q->horizontalHeaderItem(0)->setTextAlignment(Qt::AlignCenter);
  q->horizontalHeaderItem(1)->setTextAlignment(Qt::AlignCenter);
  q->horizontalHeaderItem(2)->setTextAlignment(Qt::AlignCenter);
  q->horizontalHeaderItem(3)->setTextAlignment(Qt::AlignCenter);
  q->horizontalHeaderItem(4)->setTextAlignment(Qt::AlignCenter);
  q->horizontalHeaderItem(5)->setTextAlignment(Qt::AlignCenter);
  q->horizontalHeaderItem(6)->setTextAlignment(Qt::AlignCenter);
}
