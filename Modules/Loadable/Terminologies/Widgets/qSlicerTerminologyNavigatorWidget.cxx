...
qSlicerTerminologyNavigatorWidgetPrivate::qSlicerTerminologyNavigatorWidgetPrivate(qSlicerTerminologyNavigatorWidget& object)
  ...
  , AnatomicContextComboboxPopulating(false)
    , dialogColor(vtkSlicerTerminologyType::INVALID_COLOR[0], vtkSlicerTerminologyType::INVALID_COLOR[1], vtkSlicerTerminologyType::INVALID_COLOR[2])
{
...
void qSlicerTerminologyNavigatorWidgetPrivate::init()
{
  ...
  this->SearchBox_Type->setClearIcon(QIcon(":/Icons/clear1.png"));
  this->SearchBox_Type->setSearchIcon(QIcon(":/Icons/Search1.png"));
  this->SearchBox_Category->setClearIcon(QIcon(":/Icons/clear1.png"));
  this->SearchBox_Category->setSearchIcon(QIcon(":/Icons/Search1.png"));
  this->SearchBox_AnatomicRegion->setClearIcon(QIcon(":/Icons/clear1.png"));
  this->SearchBox_AnatomicRegion->setSearchIcon(QIcon(":/Icons/Search1.png"));
...
void qSlicerTerminologyNavigatorWidget::setColorRGB(QColor color)
{
    Q_D(qSlicerTerminologyNavigatorWidget);
    d->GeneratedColor = color;
    d->dialogColor = color;
...
void qSlicerTerminologyNavigatorWidget::updateWidgetFromCurrentCategory()
{
  ...
  if (this->anatomicRegionSectionVisible())
    ...
    if (d->CurrentCategoryObject->GetShowAnatomy())
      ...
      d->frame_Category->hide();
      d->frame->hide();
      d->frame_AnatomicRegion->hide();
...
{
  Q_D(qSlicerTerminologyNavigatorWidget);
  d->CategoryExpandButton->setDown(false);
  d->AnatomicalRegionExpandButton->setDown(false);
}
...
{
  Q_D(qSlicerTerminologyNavigatorWidget);
  d->CategoryExpandButton->setDown(true);
  d->AnatomicalRegionExpandButton->setDown(true);
}
