...
void qMRMLSubjectHierarchyModelPrivate::init()
{
  ...
  q->setHorizontalHeaderLabels(
    QStringList() << "测量类型" << "描述" << "" /*visibility*/ << "" /*color*/ << "" /*transform*/ << "IDs" );

  //q->horizontalHeaderItem(q->nameColumn())->setToolTip(qMRMLSubjectHierarchyModel::tr("节点名称和类型"));
  //q->horizontalHeaderItem(q->descriptionColumn())->setToolTip(qMRMLSubjectHierarchyModel::tr("节点描述"));
  ...
  q->horizontalHeaderItem(q->nameColumn())->setTextAlignment(Qt::AlignHCenter);
  q->horizontalHeaderItem(q->descriptionColumn())->setTextAlignment(Qt::AlignHCenter);
