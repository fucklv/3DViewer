...
::init()
{
  ...
  this->ColorMapWidget->layout()->setSpacing(6);
...
void qMRMLTransformDisplayNodeWidget::on_RegionNodeRenameTFsButton_clicked()
{
    Q_D(qMRMLTransformDisplayNodeWidget);

    d->RegionNodeComboBox->renameCurrentNode();
}

void qMRMLTransformDisplayNodeWidget::on_RegionNodeEditTFsButton_clicked()
{
    Q_D(qMRMLTransformDisplayNodeWidget);

    d->RegionNodeComboBox->editCurrentNode();
}

void qMRMLTransformDisplayNodeWidget::on_RegionNodeDeleteTFsButton_clicked()
{
    Q_D(qMRMLTransformDisplayNodeWidget);

    d->RegionNodeComboBox->removeCurrentNode();
}
