...
protected slots:
  ...
  //2020/11/16
  void on_RenameCurrentTFButton_clicked();

  void onCreateNewTFButtonTriggered();

  void onCreateNewASTFButtonTriggered();

  void on_DleCurrentTFButton_clicked();

  void on_EditVolumeTFButton_clicked();

  void on_DeleteVolumeTFButton_clicked();
