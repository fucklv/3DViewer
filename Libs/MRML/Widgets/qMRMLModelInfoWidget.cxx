...
void qMRMLModelInfoWidgetPrivate::init()
{
  ...
  this->MeshTypeLabel->setVisible(false);
  this->MeshTypeLineEdit->setVisible(false);
  this->NumberOfPointsLabel->setVisible(false);
  this->NumberOfPointsSpinBox->setVisible(false);
  this->NumberOfCellsLabel->setVisible(false);
  this->ExpandButton->setVisible(false);
  this->NumberOfCellsSpinBox->setVisible(false);
  this->widget->setVisible(false);
  this->NumberOfPointsScalarsLabel->setVisible(false);
  this->NumberOfPointsScalarsSpinBox->setVisible(false);
  this->NumberOfCellsScalarsLabel->setVisible(false);
  this->NumberOfCellsScalarsSpinBox->setVisible(false);
  this->FileNameLabel->setVisible(false);
  this->FileNameLineEdit->setVisible(false);
}
