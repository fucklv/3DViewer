...
void qMRMLSliceControllerWidgetPrivate::setupPopupUi()
{
  ...
  this->SegmentationOpacitySlider->spinBox()->setVisible(false);
  this->LabelMapOpacitySlider->spinBox()->setVisible(false);
  this->ForegroundOpacitySlider->spinBox()->setVisible(false);
  this->BackgroundOpacitySlider->spinBox()->setVisible(false);
  ...
  this->ForegroundComboBox->setRenameEnabled(false);
  this->ForegroundComboBox->setEditEnabled(false);
  this->BackgroundComboBox->setRenameEnabled(false);
  this->BackgroundComboBox->setEditEnabled(false);
  ...
  //cxc
  this->RulerButton->setVisible(false);
  this->SliceSpacingButton->setVisible(false);
  this->LightBoxToolButton->setVisible(false);
  this->SliceCompositeButton->setVisible(false);
  this->OrientationMarkerButton->setVisible(true);

  this->SegmentSelectorWidget->setVisible(false);
  this->SegmentationOutlineButton->setVisible(false);
  this->SegmentationVisibilityButton->setVisible(false);
  this->SegmentationIconLabel->setVisible(false);
  this->LabelMapComboBox->setVisible(false);
  this->LabelMapOutlineButton->setVisible(false);
  this->LabelMapVisibilityButton->setVisible(false);
  this->LabelMapIconLabel->setVisible(false);
  //this->ForegroundInterpolationButton->setVisible(false);
  this->ForegroundIconLabel->setVisible(false);
  //this->BackgroundInterpolationButton->setVisible(false);
  this->BackgroundIconLabel->setVisible(false);
  this->PopupWidget->setFixedHeight(100);
...
void qMRMLSliceControllerWidgetPrivate::init()
{
  ...
  //this->SliceOffsetSlider->setToolTip(qMRMLSliceControllerWidget::tr("距RAS原点的切片距离"));
  ...
  this->SliceOffsetSlider->spinBox()->setVisible(false);
  ...
  q->moveBackgroundComboBox(true);
  q->updateSegmentationControlsVisibility();
  q->moveBackgroundComboBox(false);
  q->updateSegmentationControlsVisibility();
}
...
void qMRMLSliceControllerWidgetPrivate::setupLightboxMenu()
{
  ...
  this->LightBoxRowsSpinBox->setVisible(false);
  ...
  this->LightBoxColumnsSpinBox->setVisible(false);
...
void qMRMLSliceControllerWidgetPrivate::setupSliceSpacingMenu()
{
  ...
  this->SliceSpacingSpinBox->setVisible(false);
  ...
  this->SliceFOVSpinBox->setVisible(false);
...
void qMRMLSliceControllerWidgetPrivate::setupSliceModelMenu()
{
  ...
  // Slice model mode
  this->SliceModelMenu = new QMenu(tr("切片模型模式"), this->SliceVisibilityButton);
  ...
  this->SliceModelFOVXSpinBox->setVisible(false);
  ...
  this->SliceModelFOVYSpinBox->setVisible(false);
  ...
  this->SliceModelDimensionXSpinBox->setVisible(false);
  ...
  this->SliceModelDimensionYSpinBox->setVisible(false);
  ...
  this->SliceModelOriginXSpinBox->setVisible(false);
  ...
  this->SliceModelOriginYSpinBox->setVisible(false);
    ...
    vtkMRMLSliceNode* sliceNode, QComboBox* sliceOrientationSelector)
{
  ...
  for (int idx = 0; idx < orientationNames->GetNumberOfValues(); ++idx)
    {
      //QString str1 = QString::fromStdString(orientationNames->GetValue(idx));
...
void qMRMLSliceControllerWidgetPrivate::updateWidgetFromMRMLSliceNode()
{
  ...
  QString strName = this->MRMLSliceNode->GetLayoutLabel();
  if (strName == "R")
  {
      this->p_ViewLabel->setStyleSheet("QLabel {font: 10pt SimHei; background-color : #f34a33}");
  }
  else if (strName == "G")
  {
      this->p_ViewLabel->setStyleSheet("QLabel {font: 10pt SimHei; background-color : #6eb04b}");
  }
  else if (strName == "Y")
  {
      this->p_ViewLabel->setStyleSheet("QLabel {font: 10pt SimHei; background-color : #edd54c}");
  }
  this->ViewLabel->setText(strName);
...
void qMRMLSliceControllerWidget::setSliceOrientation(const QString& orientation)
{
  ...
  //if (orientation == "轴向")
  //{
  //    strOrientation = "Axial";
  //}
  //else if (orientation == "矢状")
  //{
  //    strOrientation = "Sagittal";
  //}
  //else if (orientation == "冠状")
  //{
  //    strOrientation = "Coronal";
  //}
  //else if (orientation == "格式化")
  //{
  //    strOrientation = "Reformat";
  //}
...
void qMRMLSliceControllerWidget::moveBackgroundComboBox(bool more)
{
  ...
  if (more)
    ...
    d->PopupWidget->setFixedHeight(100);
    }
  else
    {
    d->SliceFrame->layout()->addWidget(d->BackgroundComboBox);
    d->PopupWidget->setFixedHeight(30);
    }
  ...
  //cxc
  d->RulerButton->setVisible(false);
  d->SliceSpacingButton->setVisible(false);
  d->LightBoxToolButton->setVisible(false);
  d->SliceCompositeButton->setVisible(false);
  d->OrientationMarkerButton->setVisible(false);

  d->SegmentSelectorWidget->setVisible(false);
  d->SegmentationOutlineButton->setVisible(false);
  d->SegmentationVisibilityButton->setVisible(false);
  d->SegmentationIconLabel->setVisible(false);
  d->LabelMapComboBox->setVisible(false);
  d->LabelMapOutlineButton->setVisible(false);
  d->LabelMapVisibilityButton->setVisible(false);
  d->LabelMapIconLabel->setVisible(false);
  //d->ForegroundInterpolationButton->setVisible(false);
  d->ForegroundIconLabel->setVisible(false);
  //d->BackgroundInterpolationButton->setVisible(false);
  d->BackgroundIconLabel->setVisible(false);
}
...
void qMRMLSliceControllerWidget::updateSegmentationControlsVisibility()
{
  ...
  d->ForegroundComboBox->setVisible(visible);
  d->ForegroundInterpolationButton->setVisible(visible);
  //d->BackgroundComboBox->setVisible(visible);
  d->BackgroundInterpolationButton->setVisible(visible);
  d->ForegroundOpacitySlider->setVisible(visible);
  d->ShowReformatWidgetToolButton->setVisible(true);
  d->SliceRotateToVolumePlaneButton->setVisible(true);
}
