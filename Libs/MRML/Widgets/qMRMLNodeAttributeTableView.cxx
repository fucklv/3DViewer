...
void qMRMLNodeAttributeTableViewPrivate::init()
{
  ...
  this->NodeAttributesTable->horizontalHeader()->setSectionResizeMode(QHeaderView::Stretch);
  this->NodeAttributesTable->setAlternatingRowColors(false);
