...
void qMRMLThreeDViewControllerWidgetPrivate::setupPopupUi()
{
  ...
  //kyo
  QObject::connect(ProgressbarFile::getInstance(), SIGNAL(test(int)), q,SLOT(setOrientationMarkerType(int)));
  ...
  /*this->AxesWidget->setVisible(false);
  this->ZoomOutButton->setVisible(false);
  this->ZoomInButton->setVisible(false);
  this->VisibilityButton->setVisible(false);
  this->ViewLinkButton->setVisible(false);
  this->StereoButton->setVisible(false);
  this->SpinButton->setVisible(false);
  this->RulerButton->setVisible(false);
  this->RockButton->setVisible(false);
  this->OrthoButton->setVisible(false);
  this->OrientationMarkerButton->setVisible(false);
  this->MoreToolButton->setVisible(false);
...
void qMRMLThreeDViewControllerWidgetPrivate::init()
{
  ...
  this->BarLayout->insertWidget(0, this->CenterToolButton);

  this->ViewLabel->setText(qMRMLThreeDViewControllerWidget::tr(""));
  this->ViewLabel->setVisible(false);
  this->BarLayout->addStretch(1);
  this->PopupWidget->setFixedHeight(0);
...
void qMRMLThreeDViewControllerWidget::updateWidgetFromMRMLView()
{
  ...
  this->set3DAxisVisible(false);
  this->set3DAxisLabelVisible(false);
