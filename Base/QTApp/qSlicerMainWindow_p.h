...
class qSlicerMouseModeToolBar;
class qSlicerViewersToolBar;
...
public:
  ...
  bool                            m_bPressed = false; //鼠标是否按下属性
  QPoint                          m_point;            //按下后当前鼠标位置属性
  qSlicerMouseModeToolBar*		  MouseModeToolBar;    //鼠标toolbar
  qSlicerViewersToolBar*          ViewersToolBar;

  QMenu* LayoutMenu;
  QMenu* menuConventionalQuantitative;
  QMenu* menuFourUpQuantitative;
  QMenu* menuOneUpQuantitative;
  QMenu* menuThreeOverThreeQuantitative;
};
