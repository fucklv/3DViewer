...
void qSlicerMouseModeToolBarPrivate::init()
{
  ...
  /* this->AdjustViewAction->setToolTip(qSlicerMouseModeToolBar::tr("Translate/rotate view, adjust displayed objects"));*/
      this->AdjustViewAction->setToolTip(qSlicerMouseModeToolBar::tr("\350\247\206\345\233\276\346\216\247\345\210\266"));
  this->AdjustViewAction->setIcon(QIcon(":/Icons/Icons/ChoiceWindow.png"));
  ...
  //QToolButton* exampleButton1 = new QToolButton(q);
  //exampleButton1->setDefaultAction(this->AdjustViewAction);
  //exampleButton1->setPopupMode(QToolButton::InstantPopup);

  q->addAction(this->AdjustViewAction);
  //q->addWidget(exampleButton1);
  this->InteractionModesActionGroup->addAction(this->AdjustViewAction);
  QLabel* label1 = new QLabel;
  label1->setFixedWidth(8);
  q->addWidget(label1);
  ...
  //->AdjustWindowLevelCenteredRegionModeAction->setToolTip(
 ...
 /* this->AdjustWindowLevelAction->setToolTip(qSlicerMouseModeToolBar::tr(
  ...
  this->AdjustWindowLevelAction->setToolTip(qSlicerMouseModeToolBar::tr("\347\252\227\345\256\275\347\252\227\344\275\215"));
  this->AdjustWindowLevelAction->setIcon(QIcon(":/Icons/Icons/EditWindow.png"));
  ...
  //QToolButton * exampleButton2 = new QToolButton(q);
  //exampleButton2->setDefaultAction(this->AdjustWindowLevelAction);
  //exampleButton2->setPopupMode(QToolButton::MenuButtonPopup);
  //exampleButton2->setStyleSheet("QToolButton::menu-button{border: none;}");

  QObject::connect(this->AdjustWindowLevelAction, SIGNAL(toggled(bool)),
    q, SLOT(interactionModeActionTriggered(bool)));

  q->addAction(this->AdjustWindowLevelAction);
  //q->addWidget(exampleButton2);
  ...
  //QToolButton* exampleButton3 = new QToolButton(q);
  //exampleButton3->setDefaultAction(this->PlaceWidgetAction);
  //exampleButton3->setPopupMode(QToolButton::InstantPopup);

  //q->addWidget(exampleButton3);
...
void qSlicerMouseModeToolBarPrivate::updateWidgetFromMRML()
{
  ...
  foreach(QAction* action, this->PlaceModesActionGroup->actions())
    ...
    if (action->data().toString() == activePlaceNodeClassName)
      ...
      this->PlaceWidgetAction->setIcon(QIcon(":/Icons/Icons/SignWindow.png"));
...
void qSlicerMouseModeToolBarPrivate::updatePlaceWidgetMenuActionList()
{
  ...
  for (int i = 0; i < numClassNames; ++i)
    ...
    if (!action)
      ...
      if ((placeNodeIconName == "Ruler") || (placeNodeIconName == "ROI") || (placeNodeIconName == "Plane"))
      {
          this->PlaceWidgetAction->menu()->removeAction(action);
          this->PlaceModesActionGroup->removeAction(action);
      }
      }
    // update it
