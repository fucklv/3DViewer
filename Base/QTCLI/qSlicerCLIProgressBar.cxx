  ...
  :q_ptr(&object)
{
  ...
  this->StatusVisibility = qSlicerCLIProgressBar::AlwaysHidden;
...
void qSlicerCLIProgressBarPrivate::init()
{
  ...
  this->DetailsTextExpandButton->setStyleSheet("QToolButton{ min-width: 24px; min-height: 24px; max-width: 24px; max-height: 24px; background: #191925; border: 1px solid #5c5c74;} QToolButton::hover{ background-color: #5C5C74;}");
  this->DetailsTextExpandButton->setVisible(false);

  this->GridLayout->addWidget(DetailsTextExpandButton, 1, 2, 1, 1);
  this->GridLayout->setContentsMargins(9, 9, 9, 9);
  ...
  //kyo
  this->StatusLabelLabel->setVisible(false);
  this->StatusLabel->setVisible(false);

  this->NameLabel->setText("");
  this->StatusLabelLabel->setText(qSlicerCLIProgressBar::tr("\347\212\266\346\200\201:"));
  this->StatusLabel->setText(qSlicerCLIProgressBar::tr("\347\251\272\351\227\262"));
