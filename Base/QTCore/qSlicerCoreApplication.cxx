...
/*!
 * \brief SegmentEditor加入外部插件（已有 AIAA插件）
 */
void qSlicerCoreApplication::addSegmentEditorExtraPlugIn()
{
    QString applicationPath = QString("%1%2").arg(QCoreApplication::applicationDirPath()).arg("/slicer-plugin/");
    QVariant valuePath = this->revisionUserSettings()->value("Modules/AdditionalPaths");
    QStringList SlicerPlugInPath;
    SlicerPlugInPath
        //<< "D:/Desktop/slicer-plugin/slicer-plugin/NvidiaAIAA"
        //<< "D:/Desktop/slicer-plugin/slicer-plugin/MarkupsToModel/qt-loadable-modules"
        //<< "D:/Desktop/slicer-plugin/slicer-plugin/SegmentEditorExtraEffects/qt-scripted-modules"
        << applicationPath + "NvidiaAIAA"
        << applicationPath + "SegmentEditorDrawTube"
        ///<< applicationPath + "SegmentEditorEngrave"
        ///<< applicationPath + "SegmentEditorMaskVolume"
        << applicationPath + "SegmentEditorSurfaceCut"
        ///<< applicationPath + "SegmentEditorWrapSolidify"
        << applicationPath + "SlicerElastix/qt-scripted-modules"
        << applicationPath + "MarkupsToModel/qt-loadable-modules";
        ///<< "D:/Desktop/slicer-plugin/slicer-plugin/ChestImageingPlatform/cli-modules"
        ///<< "D:/Desktop/slicer-plugin/slicer-plugin/ChestImageingPlatform/qt-loadable-modules"
        ///<< "D:/Desktop/slicer-plugin/slicer-plugin/ChestImageingPlatform/qt-scripted-modules";
        ///<< applicationPath + "ChestImageingPlatform/cli-modules"
        ///<< applicationPath + "ChestImageingPlatform/qt-loadable-modules"
        ///<< applicationPath + "ChestImageingPlatform/qt-scripted-modules";

    if (valuePath != SlicerPlugInPath)
    {
        this->revisionUserSettings()->setValue("Modules/AdditionalPaths", QVariant(SlicerPlugInPath));
        //this->revisionUserSettings()->setValue("Modules/MostRecentlySelectedPath", QVariant(str));
