...
class SegmentEditorEffect(AbstractScriptedSegmentEditorEffect):
  ...
  def __init__(self, scriptedEffect):
    ...
    scriptedEffect.toolTipName = '文字工具'
  ...
  def setupOptionsFrame(self):
    ...
    iconTextLabel.setText(" 文字工具")
    iconTextLabel.setStyleSheet("QLabel{ font: 12pt 'SimHei';}")
    iconImageLabel.setStyleSheet("QLabel{min-width: 13; min-height: 13; max-width: 13; max-height: 13;background-image: url(:/Icons/SegmentEditorEffectEngraveSg1.png)}")
    ...
    self.textLineEditLabel = self.scriptedEffect.addLabeledOptionsWidget("文字：", self.textLineEdit)
    ...
    markupsActionLayout.addStretch()
    self.scriptedEffect.addLabeledOptionsWidget("位置：", markupsActionLayout)
    ...
    self.textHeightLabel = self.scriptedEffect.addLabeledOptionsWidget("文字高度：", self.textHeightSlider) 
    ...
    modeLayout.setSpacing(40)
    ModeLabel = qt.QLabel()
    ModeLabel.setText("模式：")
    
    self.scriptedEffect.addOptionsWidget(ModeLabel)
    ...
    self.cancelButton.setStyleSheet("QPushButton{font: 10pt 'SimHei'; min-width: 68; min-height: 24; max-width: 68; max-height: 24; background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    self.applyButton.setStyleSheet("QPushButton{font: 10pt 'SimHei'; min-width: 68; min-height: 24; max-width: 68; max-height: 24; background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    self.textLineEdit.setStyleSheet("QLineEdit{font: 10pt 'SimHei'; min-height: 21; max-height: 21; background: #191925; border: 1px solid #5c5c74;} QLineEdit:hover{background-color: #5C5C74;}")
    self.textHeightSlider.setStyleSheet("QDoubleSpinBox{background: #1a1a26; border: 1px solid #5c5c74; min-height:21px; max-height:21px; min-width: 82px; max-width: 82px; color: rgb(255, 255, 255);}")
    self.textDepthSlider.setStyleSheet("QDoubleSpinBox{background: #1a1a26; border: 1px solid #5c5c74; min-height:21px; max-height:21px; min-width: 82px; max-width: 82px; color: rgb(255, 255, 255);}")
