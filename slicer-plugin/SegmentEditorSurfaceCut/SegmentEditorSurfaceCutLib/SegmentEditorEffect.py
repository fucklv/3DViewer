...
class SegmentEditorEffect(AbstractScriptedSegmentEditorEffect):
  ...
  def setupOptionsFrame(self):
    ...
    iconTextLabel.setText(" 切面")
    iconTextLabel.setStyleSheet("QLabel{ font: 12pt 'SimHei';}")
    iconImageLabel.setStyleSheet("QLabel{min-width: 14; min-height: 14; max-width: 14; max-height: 14;background-image: url(:/Icons/SegmentEditorEffectSurfaceCut.png)}")
    ...
    self.scriptedEffect.addLabeledOptionsWidget("基准位置：", fiducialAction)
    ...
    operationLayout.addWidget(self.setButton, 1, 0)
    operationLayout.addWidget(self.eraseOutsideButton, 1, 1)
    operationLayout.addWidget(self.fillOutsideButton, 2, 0)
    
    OperationLabel = qt.QLabel()
    OperationLabel.setText("操作：")
    self.scriptedEffect.addOptionsWidget(OperationLabel)
    self.scriptedEffect.addOptionsWidget(operationLayout)
    operationLayout.setVerticalSpacing(12)
    operationLayout.setContentsMargins(0,8,0,8)
    ...
    SmoothHLayout = qt.QHBoxLayout()
    SmoothLabel = qt.QLabel()
    SmoothLabel.setText("平滑模型：")
    SmoothHLayout.addWidget(SmoothLabel)
    SmoothHLayout.addWidget(self.smoothModelCheckbox)
    SmoothHLayout.addStretch()
    SmoothHLayout.setSpacing(6)
    self.scriptedEffect.addOptionsWidget(SmoothHLayout)
