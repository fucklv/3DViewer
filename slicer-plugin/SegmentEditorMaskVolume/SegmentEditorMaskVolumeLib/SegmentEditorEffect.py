...
modifiable.
  ...
  def setupOptionsFrame(self):
    ...
    iconTextLabel.setText(" 蒙版")
    iconTextLabel.setStyleSheet("QLabel{ font: 12pt 'SimHei';}")
    iconImageLabel.setStyleSheet("QLabel{min-width: 13; min-height: 11; max-width: 13; max-height: 11;background-image: url(:/Icons/SegmentEditorEffectMaskVolume.png)}")
    ...
    # fill value
    fillValueHLayout = qt.QHBoxLayout()
    ...
    self.fillValueEdit.setFixedWidth(109)
    self.fillValueEdit.connect("valueChanged(int)", self.fillValueChanged)
    fillValueHLayout.addWidget(self.fillValueEdit)
    fillValueHLayout.addStretch()
    ...
    fillValueLayout.addRow(self.fillValueLabel, fillValueHLayout)
