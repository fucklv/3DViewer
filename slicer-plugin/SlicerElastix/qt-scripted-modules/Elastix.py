...
class ElastixWidget(ScriptedLoadableModuleWidget):
  ...
  def setup(self):
    ...
    iconFrame.setContentsMargins(6,8,0,10)
    
    iconTextLabel.setText("  General Registration (Elastix)")
    iconTextLabel.setStyleSheet("QLabel{ font: 16pt 'Microsoft YaHei';}")
    iconImageLabel.setStyleSheet("""QLabel{min-width: 17; min-height: 17; max-width: 17; max-height: 17; border-image: url(:/Icons/Icons/ExtensionCj.png);}""")
    
    iconFrame.addWidget(iconImageLabel)
    iconFrame.addWidget(iconTextLabel)
    iconFrame.addStretch()
    
    iconWidget.setLayout(iconFrame)
    self.layout.addWidget(iconWidget)

    # Parameter sets
    defaultinputParametersCollapsibleButton = ctk.ctkCollapsibleButton()
    defaultinputParametersCollapsibleButton.text = "参数设置"
    ...
    defaultParametersLayout.setContentsMargins(8,8,8,8)
    defaultParametersLayout.layout().setSpacing(10);
    defaultinputParametersCollapsibleButton.visible = False
    
    defaultinputParametersCollapsibleButton.setStyleSheet("""QWidget {
	border: none;
	background: #28293a;
    ...
    self.parameterNodeSelector.setStyleSheet("""QComboBox {
        color: rgb(255, 255, 255);
        background: #191925;
    ...
    inputParametersCollapsibleButton.text = "输入"
    self.layout.addWidget(inputParametersCollapsibleButton)
    
    inputParametersCollapsibleButton.setStyleSheet("""QWidget {
	border: none;
	background: #28293a;
    font: 10pt "Microsoft YaHei";
    color: rgb(255, 255, 255);}""")
    ...
    inputParametersFormLayout.setContentsMargins(8,8,8,8)
    inputParametersFormLayout.layout().setSpacing(10);
    #
    ...
    self.fixedVolumeSelector.setStyleSheet("""QComboBox {
        color: rgb(255, 255, 255);
        background: #191925;
        border: 1px solid #5c5c74;
        font: 10pt "Microsoft YaHei";
    ...
    self.movingVolumeSelector.setStyleSheet("""QComboBox {
        color: rgb(255, 255, 255);
        background: #191925;
        border: 1px solid #5c5c74;
        font: 10pt "Microsoft YaHei";
    ...
    self.registrationPresetSelector.setStyleSheet("""QComboBox {
        color: rgb(255, 255, 255);
        background: #191925;
        border: 1px solid #5c5c74;
        font: 10pt "Microsoft YaHei";
    ...
    maskingParametersCollapsibleButton.setStyleSheet("""QWidget {
	border: none;
	background: #28293a;
    font: 10pt "Microsoft YaHei";
    color: rgb(255, 255, 255);}""")
    ...
    maskingParametersFormLayout.setContentsMargins(8,8,8,8)
    maskingParametersFormLayout.layout().setSpacing(10);
    maskingParametersCollapsibleButton.visible = False
    ...
    self.fixedVolumeMaskSelector.setStyleSheet("""QComboBox {
        color: rgb(255, 255, 255);
        background: #191925;
        border: 1px solid #5c5c74;
        font: 10pt "Microsoft YaHei";
    ...
    self.movingVolumeMaskSelector.setStyleSheet("""QComboBox {
        color: rgb(255, 255, 255);
        background: #191925;
        border: 1px solid #5c5c74;
        font: 10pt "Microsoft YaHei";
    ...
    outputParametersCollapsibleButton.text = "输出"
    self.layout.addWidget(outputParametersCollapsibleButton)
    
    outputParametersCollapsibleButton.setStyleSheet("""QWidget {
	border: none;
	background: #28293a;
    font: 10pt "Microsoft YaHei";
    color: rgb(255, 255, 255);}""")
    ...
    outputParametersFormLayout.setContentsMargins(8,8,8,8)
    outputParametersFormLayout.layout().setSpacing(10);
    ...
    self.outputVolumeSelector.renameEnabled = False
    ...
    self.outputVolumeSelector.setStyleSheet("""QComboBox {
        color: rgb(255, 255, 255);
        background: #191925;
        border: 1px solid #5c5c74;
        font: 10pt "Microsoft YaHei";
    ...
    self.outputTransformSelector.renameEnabled = False
    self.outputTransformSelector.removeEnabled = False
    ...
    self.outputTransformSelector.setStyleSheet("""QComboBox {
        color: rgb(255, 255, 255);
        background: #191925;
        border: 1px solid #5c5c74;
        font: 10pt "Microsoft YaHei";
    ...
    self.advancedCollapsibleButton.text = "高级选项"
    self.advancedCollapsibleButton.collapsed = True
    self.layout.addWidget(self.advancedCollapsibleButton)
    advancedFormLayout = qt.QFormLayout(self.advancedCollapsibleButton)
    advancedFormLayout.setContentsMargins(8,8,8,8)
    advancedFormLayout.layout().setSpacing(10);
    self.advancedCollapsibleButton.visible = False
    
    self.advancedCollapsibleButton.setStyleSheet("""QWidget {
	border: none;
	background: #28293a;
    font: 10pt "Microsoft YaHei";
    color: rgb(255, 255, 255);}""")
    ...
    self.forceDisplacementFieldOutputChecbox.setStyleSheet("""QCheckBox {
	color: rgb(255, 255, 255);
    spacing: 7px;}
    QCheckBox::indicator {
    width: 16px;
    ...
    self.showDetailedLogDuringExecutionCheckBox.setStyleSheet("""QCheckBox {
	color: rgb(255, 255, 255);
    spacing: 7px;}
    QCheckBox::indicator {
    width: 16px;
    ...
    self.keepTemporaryFilesCheckBox.setStyleSheet("""QCheckBox {
	color: rgb(255, 255, 255);
    spacing: 7px;}
    QCheckBox::indicator {
    width: 16px;
    ...
    self.showTemporaryFilesFolderButton = qt.QPushButton("显示文件夹")
    ...
    self.showTemporaryFilesFolderButton.setStyleSheet("QPushButton{font: 10pt 'SimHei';min-width: 82; min-height: 24;max-width: 82; max-height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    ...
    self.showRegistrationParametersDatabaseFolderButton = qt.QPushButton("显示文件夹")
    ...
    hboxs = qt.QHBoxLayout()
    hboxs.addStretch(1)
    hboxs.addWidget(self.showRegistrationParametersDatabaseFolderButton)
    advancedFormLayout.addRow("Registration presets:", hboxs)
    
    self.showRegistrationParametersDatabaseFolderButton.setStyleSheet("QPushButton{font: 10pt 'SimHei';min-width: 82; min-height: 24;max-width: 82; max-height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    ...
    self.customElastixBinDirSelector.setStyleSheet("""QComboBox {
        color: rgb(255, 255, 255);
        background: #191925;
        border: 1px solid #5c5c74;
        font: 10pt "Microsoft YaHei";
        ...
        QComboBox::down-arrow {
        image: url(:/Icons/comboBoxDown1.png);}
        QToolButton{font: 10pt 'SimHei';min-width: 21px; min-height: 21px;max-width: 21px; max-height: 21px;background: #191925; border: 1px solid #5c5c74;}QToolButton:hover{background-color: #5C5C74;}""")
    ...
    font: 10pt 'SimHei';width: 68;
    height: 24;background: #191925;
    border: 1px solid #5c5c74;}
    ...
    self.statusLabel.setStyleSheet("QPlainTextEdit{font: 10pt 'SimHei'; background: #191925; border: 1px solid #5c5c74;}")
