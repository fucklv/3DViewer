...
class SegmentEditorEffect(AbstractScriptedSegmentEditorEffect):
  ...
  def __init__(self, scriptedEffect):
    ...
    scriptedEffect.toolTipName = '画管子'
  ...
  def setupOptionsFrame(self):
    ...
    iconTextLabel.setText(" 画管子")
    iconTextLabel.setStyleSheet("QLabel{ font: 12pt 'SimHei';}")
    iconImageLabel.setStyleSheet("QLabel{min-width: 13; min-height: 13; max-width: 13; max-height: 13;background-image: url(:/Icons/SegmentEditorEffectSg1.png)}")
    ...
    self.editButton.text = ""
    self.editButton.setIcon(qt.QIcon(':/Icons/EditSg1.png'))
    self.editButton.setIconSize(qt.QSize(14,12))
    
    
    #FiducialLabel = qt.QLabel()
    #FiducialLabel.setText("基准位置：")
    ...
    fiducialActionLayout.addStretch()
    
    #self.scriptedEffect.addOptionsWidget(fiducialActionLayout)
    self.scriptedEffect.addLabeledOptionsWidget("基准位置：", fiducialActionLayout)
    ...
    self.radiusSpinBox.setFixedWidth(130)
    
    RadiusLabel = qt.QLabel()
    RadiusLabel.setText("半径：")
    
    RadiusLayout = qt.QHBoxLayout()
    RadiusLayout.addWidget(RadiusLabel)
    RadiusLayout.addWidget(self.radiusSpinBox)
    RadiusLayout.addStretch()
    RadiusLayout.setContentsMargins(0,8,0,8)
    self.scriptedEffect.addOptionsWidget(RadiusLayout)
    ...
    self.globalPolynomialButton.visible = False
    ...
    self.movingPolynomialButton.visible = False
    ...
    interpolationLayout.addWidget(self.movingPolynomialButton, 2, 0)

    InterpolationLabel = qt.QLabel()
    InterpolationLabel.setText("插值：")
    self.scriptedEffect.addOptionsWidget(InterpolationLabel)
    self.scriptedEffect.addOptionsWidget(interpolationLayout)
    interpolationLayout.setVerticalSpacing(12)
    interpolationLayout.setContentsMargins(0,8,0,8)
    ...
    self.cancelButton.setStyleSheet("QPushButton{font: 10pt 'SimHei';width: 68; height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    self.applyButton.setStyleSheet("QPushButton{font: 10pt 'SimHei';width: 68; height: 24;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
    self.editButton.setStyleSheet("QPushButton{font: 10pt 'SimHei';width: 28; height: 21;background: #191925; border: 1px solid #5c5c74;}QPushButton:hover{background-color: #5C5C74;}")
